...
export async function POST(request: Request) {
  ...
  const fields = Object.fromEntries(["name", "birthDate", "gender", "height", "relationshipIntent", "alcoholUse", "smokingUse", "politicalView", "musicTaste", "instagramUsername", "spotifyUrl", "city", "level", "bio", "surftripDestination", "surftripArrivalDate", "surftripDepartureDate"].map(key => [key, String(form.get(key) ?? "").trim()]));
  ...
  const requiredFields = ["name", "birthDate", "gender", "height", "relationshipIntent", "alcoholUse", "smokingUse", "politicalView", "musicTaste", "city", "level", "bio", "surftripDestination", "surftripArrivalDate", "surftripDepartureDate"];
