      ...
      {signup && <div className="modalback" role="presentation">
        <section className="signup" role="dialog" aria-modal="true" aria-labelledby="signup-title">
          ...
          {user && <form onSubmit={submit}>
            ...
            <label>Posicionamento político<select required value={draft.politicalView} onChange={e => setDraft({...draft,politicalView:e.target.value})}><option value="">Selecione</option><option>Esquerda</option><option>Centro-esquerda</option><option>Centro</option><option>Centro-direita</option><option>Direita</option><option>Apolítico</option><option>Prefiro não informar</option></select></label>
